...
unsigned int charge_boost_trigger = 95;
...
#define DEFAULT_CUTOFF_VOLT_MV		3500
...
#define DEFAULT_BATT_TEMP_HOT		52
#define DEFAULT_CL_START_SOC		15
#define DEFAULT_CL_MIN_TEMP_DECIDEGC	150
#define DEFAULT_CL_MAX_TEMP_DECIDEGC	520
...
{	struct fg_chip *chip = container_of(work,
	...
	if (temp < 520 && chip->last_batt_temp >= 520) {
